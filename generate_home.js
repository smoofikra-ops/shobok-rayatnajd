...
const pageContent = `import { Container } from "@/components/ui/container";
...
export default function HomePage({ params: { locale } }: { params: { locale: string } }) {
  ...
  const movingServices = servicesData; // Use all for carousel
  ...
  return (
    <>
      ...
      {/* Solutions & Sectors remain mostly identical but translated using hardcoded or simple dict for now */}
        ...
        <Container>
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div className={\`space-y-6 relative before:absolute before:inset-y-0 \${isEn ? 'before:left-3.5' : 'before:right-3.5'} before:w-0.5 before:bg-gray-100\`}>
                {(isEn ? [
          ...
          <div className="bg-gray-900 rounded-3xl p-8 md:p-14 text-center max-w-4xl mx-auto shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href={\`/\${locale}/request-quote\`} className="w-full sm:w-auto bg-gradient-to-r from-[#4A281A] via-[#B56D2A] to-[#B9A174] text-white px-8 py-3.5 rounded-md font-bold hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
...
fs.writeFileSync('app/[locale]/page.tsx', pageContent);
